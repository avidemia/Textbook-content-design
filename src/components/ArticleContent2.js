...
const ArticleContent = () => {
    return (
        <>
            ...
            <h2 className="text-xl font-light mb-4 bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-fuchsia-500">
            ...
            <h2 className="text-xl font-light mt-8 mb-4 bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-fuchsia-500">
                2. Set Clear Goals
            </h2>
            <p className="text-slate-800 leading-relaxed mb-4">
